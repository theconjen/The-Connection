...
const textVariantStyles: Record<TextVariant, (theme: Theme) => TextStyle> = {
  body: (t) => ({ fontSize: t.fontSize.md, lineHeight: t.lineHeight.md, fontWeight: t.fontWeight.regular }),
  bodySmall: (t) => ({ fontSize: t.fontSize.sm, lineHeight: t.lineHeight.sm, fontWeight: t.fontWeight.regular }),
  label: (t) => ({ fontSize: t.fontSize.sm, lineHeight: t.lineHeight.sm, fontWeight: t.fontWeight.medium }),
  title: (t) => ({ fontSize: t.fontSize.xl, lineHeight: t.lineHeight.xl, fontWeight: t.fontWeight.semibold }),
  heading: (t) => ({ fontSize: t.fontSize['2xl'], lineHeight: t.lineHeight['2xl'], fontWeight: t.fontWeight.bold }),
  caption: (t) => ({ fontSize: t.fontSize.xs, lineHeight: t.lineHeight.xs, fontWeight: t.fontWeight.regular }),
};
