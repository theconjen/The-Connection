...
export function SocketProvider({ children }: SocketProviderProps) {
  ...
  useEffect(() => {
    ...
    const connectSocket = async () => {
      ...
      if (!SOCKET_ENABLED) {
        console.info('[Socket] Disabled - skipping connection (set SOCKET_ENABLED=true when server is ready)');
        return;
      }
      ...
      try {
        ...
        console.info('[Socket] Connecting to:', socketUrl, 'for user:', user.id);
