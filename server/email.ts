...
export async function sendWelcomeEmail(email: string, displayName: string = ""): Promise<boolean> {
  ...
  return sendEmail({
    to: email,
    from: 'noreply@faithconnect.com', // Use your verified domain
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; border: 1px solid #ddd; border-top: none;">
          ...
          <div style="margin-top: 30px; text-align: center;">
            <a href="https://faithconnect.com/login" style="background-color: #6d28d9; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;">Sign In Now</a>
          </div>
