    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isGuest && (
        <div className="mb-8 p-5 rounded-2xl border bg-card/60 shadow-sm text-center md:text-left">
          <p className="font-semibold text-lg">You are browsing as a guest</p>
          <p className="text-muted-foreground mt-1">
            Preview our community spaces, events, and groups. Create a free account when you want to post, chat, or join a group.
          </p>
