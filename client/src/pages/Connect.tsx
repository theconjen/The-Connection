...
import { Users, Calendar, MessageSquare, Map, Heart, 
         UserPlus, Video, Phone, Coffee, Handshake } from 'lucide-react';
...
export default function Connect() {
  ...
  const connectFeatures = [
    ...
    },
    {
      ...
      description: 'Join online gatherings for fellowship and discussion.',
      icon: <Video className="h-8 w-8 text-primary" />,
      link: '/virtual-meetups',
      color: 'bg-blue-50'
    },
    {
      title: 'Mentorship',
      description: 'Find or become a mentor to help others grow in their faith journey.',
    ...
    {
      title: 'Support Calls',
      description: 'Request or offer spiritual support through voice or video calls.',
