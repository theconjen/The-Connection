...
export default function PostsPage({ isGuest = false }: PostsPageProps) {
  ...
  return (
    <div className={`container mx-auto px-4 py-6`}>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Discover and engage with long-form content from the Christian community</p>
      </div>
