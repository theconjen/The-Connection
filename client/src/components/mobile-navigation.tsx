    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 w-full border-t bg-background/95 backdrop-blur-sm z-40 shadow-[0_-1px_3px_rgba(0,0,0,0.05)] safe-area-bottom">
      <div className="flex justify-around items-center px-1">
        ...
        <Link href="/" className="flex-1 touch-manipulation">
          <div className={`flex flex-col items-center py-2.5 px-1 ${activeTab === '/' ? 'text-primary' : 'text-muted-foreground'}`}>
        ...
        <Link href="/microblogs" className="flex-1 touch-manipulation">
          <div className={`flex flex-col items-center py-2.5 px-1 ${activeTab === '/microblogs' ? 'text-primary' : 'text-muted-foreground'}`}>
        ...
        <Link href="/submit-post" className="flex-1 touch-manipulation relative">
          <div className={`flex flex-col items-center py-2 ${activeTab === '/submit-post' ? 'text-primary' : 'text-muted-foreground'}`}>
            <div className={`absolute -top-5 ${activeTab === '/submit-post' ? 'bg-primary text-white' : 'bg-primary/90 text-white'} rounded-full p-3 shadow-sm`}>
        ...
        <Link href="/communities" className="flex-1 touch-manipulation">
          <div className={`flex flex-col items-center py-2.5 px-1 ${activeTab === '/communities' ? 'text-primary' : 'text-muted-foreground'}`}>
        ...
        <Link href="/forums" className="flex-1 touch-manipulation">
          <div className={`flex flex-col items-center py-2.5 px-1 ${activeTab === '/forums' ? 'text-primary' : 'text-muted-foreground'}`}>
