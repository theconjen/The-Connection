...
const getStyles = (colors: any, theme: string) => StyleSheet.create({
  ...
  content: { flex: 1 },
  postSection: { backgroundColor: colors.surface, padding: 16, borderBottomWidth: 8, borderBottomColor: colors.surfaceMuted },
  postHeader: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 12 },
  channelIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.surfaceMuted, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  channelIconText: { fontSize: 20 },
  postMeta: { flex: 1 },
  channelName: { fontSize: 14, fontWeight: '700', color: colors.textPrimary },
  ...
  postTitle: { fontSize: 20, fontWeight: '700', color: colors.textPrimary, marginBottom: 12, lineHeight: 28 },
  ...
  engagementSection: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 12, borderTopWidth: 1, borderTopColor: colors.borderSubtle },
  likeButton: { flexDirection: 'row', alignItems: 'center', gap: 6, padding: 4 },
  likeCount: { fontSize: 16, fontWeight: '600', color: colors.textPrimary },
  commentIndicator: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  commentCount: { fontSize: 14, color: colors.textSecondary },
  commentsSection: { padding: 16, backgroundColor: colors.surface },
  commentsTitle: { fontSize: 16, fontWeight: '600', color: colors.textPrimary, marginBottom: 16 },
  noComments: { fontSize: 14, color: colors.textPrimaryTertiary, textAlign: 'center', marginTop: 20 },
  commentCard: { backgroundColor: colors.surfaceNested, padding: 12, borderRadius: 8, marginBottom: 8, borderWidth: 1, borderColor: colors.borderSubtle },
  ...
  inputContainer: { flexDirection: 'row', padding: 12, paddingBottom: Platform.OS === 'ios' ? 24 : 12, backgroundColor: colors.surface, borderTopWidth: 1, borderTopColor: colors.borderSubtle, alignItems: 'center' },
  input: { flex: 1, backgroundColor: colors.input, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, maxHeight: 80, marginRight: 8, color: colors.textPrimary, borderWidth: 1, borderColor: colors.borderSubtle },
